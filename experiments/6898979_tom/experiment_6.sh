...
# This script is used to run the training for the sixth experiment
# In this experiment, ablation is done on the attention of the maxvit model
# The entire attention is removed from the model's architecture leaving just MBConv blocks
