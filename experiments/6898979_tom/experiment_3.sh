...
# This script is used to run the training for the third experiment
# In this experiment, ablation is done on the block attention of the maxvit model
# The entire block attention is removed from the model's architecture leaving just MBConv blocks and grid attention
...
MODEL_NAME="maxvit"
MODEL_VARIANT="remove_block_attn"
LEARNING_RATE="1e-4"
BATCH_SIZE="32"
