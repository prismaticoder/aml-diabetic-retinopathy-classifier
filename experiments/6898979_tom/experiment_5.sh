...
# This script is used to run the training for the fifth experiment
# In this experiment, ablation is done on the MBConv blocks of the maxvit model
# The entire MBConv blocks are removed from the model's architecture leaving just grid attention and block attention
